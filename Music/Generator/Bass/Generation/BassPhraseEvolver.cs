// AI: purpose=Apply bounded, deterministic evolution to Bass phrases for musical variation.
// AI: invariants=Do not mutate inputs; output deterministic from (seed, phraseId, evolution).
// AI: deps=MaterialPhrase uses phrase-relative ticks; relies on bassPhraseEvolutionParams and BarTrack.
...
public sealed class BassPhraseEvolver
{
    ...
    public BassPhraseEvolver(int seed)
    {
        _seed = seed;
    }
    ...
    public MaterialPhrase Evolve(MaterialPhrase original, BassPhraseEvolutionParams? evolution, BarTrack barTrack)
    {
    ...
    private static bool IsNoEvolution(BassPhraseEvolutionParams evolution)
