...
namespace Music.Generator.Groove
{
    ...
    /// </summary>
    public static class GrooveWeightedCandidateSelector
    {
        /// <summary>
        ...
        public static double ComputeWeight(GrooveOnsetCandidate candidate, GrooveCandidateGroup group)
        {
        ...
        /// </summary>
        public static string CreateStableId(GrooveCandidateGroup group, GrooveOnsetCandidate candidate)
        {
