...
//            var barContext = new DrumBarContext(BarNumber: 1, Section: section, SegmentProfile: null, BarWithinSection: 0, BarsUntilSectionEnd: 7);
...
//            var barContext = new DrumBarContext(BarNumber: 2, Section: section, SegmentProfile: null, BarWithinSection: 1, BarsUntilSectionEnd: 2);
//            var input = new DrummerContextBuildInput { BarContext = barContext };
...
//            var section = new Section { SectionType = MusicConstants.eSectionType.Verse, StartBar = 1, BarCount = 8 };
//            var barContext = new DrumBarContext(BarNumber: 8, Section: section, SegmentProfile: null, BarWithinSection: 7, BarsUntilSectionEnd: 0);
//            var input = new DrummerContextBuildInput { BarContext = barContext };
...
//            var section = new Section { SectionType = MusicConstants.eSectionType.Verse, StartBar = 1, BarCount = 8 };
//            var barContext = new DrumBarContext(BarNumber: 4, Section: section, SegmentProfile: null, BarWithinSection: 3, BarsUntilSectionEnd: 4);
//            var input = new DrummerContextBuildInput { BarContext = barContext };
...
//        {
//            // Arrange
//            var barContext = new DrumBarContext(BarNumber: 1, Section: null, SegmentProfile: null, BarWithinSection: 0, BarsUntilSectionEnd: 0);
//            var input = new DrummerContextBuildInput { BarContext = barContext };
...
//            var barContext = new DrumBarContext(BarNumber: 1, Section: section, SegmentProfile: null, BarWithinSection: 0, BarsUntilSectionEnd: 3);
...
//            var barContext = new DrumBarContext(BarNumber: 1, Section: section, SegmentProfile: null, BarWithinSection: 0, BarsUntilSectionEnd: 0);
//            var input = new DrummerContextBuildInput { BarContext = barContext };
