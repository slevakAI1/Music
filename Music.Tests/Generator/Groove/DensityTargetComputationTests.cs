...
namespace Music.Generator.Tests
{
    ...
    public class DensityTargetComputationTests
    {
        ...
        private static GrooveBarContext CreateBarContext(double density, int maxEvents)
        {
        ...
        private static GrooveBarContext CreateBarContextWithSection(double density, int maxEvents, string sectionType)
        {
            var segmentProfile = new SegmentGrooveProfile
            {
                DensityTargets = new List<RoleDensityTarget>
