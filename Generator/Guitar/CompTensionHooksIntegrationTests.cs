// AI: purpose=Story 7.5.6 tests: tension hooks bias comp velocity at phrase peaks/ends; guardrails enforced.
...
internal static class CompTensionHooksIntegrationTests
{
    /// <summary>
    /// Verifies tension VelocityAccentBias increases comp velocity at phrase peaks/ends.
    /// Story 7.5.6: Comp uses tension hooks for accent bias.
    /// </summary>
    public static void Test_TensionHooks_Increase_Velocity_At_Phrase_End()
    {
        const int baseVelocity = 85;
        ...
        // Apply velocity calculation (mirrors GuitarTrackGenerator logic)
        ...
        Console.WriteLine($"? CompTension: Neutral velocity={neutralVelocity}, Tension velocity={tensionVelocity}");
    }
    
    /// <summary>
    /// Verifies comp velocity stays within MIDI range [1, 127] even with tension bias.
    ...
    public static void Test_VelocityGuardrails_Enforced()
    {
        ...
        Console.WriteLine($"? CompTension: Velocity range [{minVelocity}, {maxVelocity}] within MIDI bounds [1, 127]");
    }
    ...
    public static void Test_TensionIntegration_Determinism()
    {
        ...
        Console.WriteLine($"? CompTension: Determinism verified (velocity={velocity1})");
    }
    
    public static void RunAllTests()
    {
        Console.WriteLine("=== Comp Tension Hooks Integration Tests ===");
        Test_TensionHooks_Increase_Velocity_At_Phrase_End();
        Test_VelocityGuardrails_Enforced();
        Test_TensionIntegration_Determinism();
        Console.WriteLine("=== All Comp Tension Tests Passed ===\n");
    }
}
